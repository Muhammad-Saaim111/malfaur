...
class TeamMemberController extends Controller
{
    ...
    public function memberPage(?string $slug = null)
    {
        ...
        $selectedMemberPayload = [
            ...
            'specialistFocus' => collect($member->specialist_focus ?? [])->values(),
            'personalStatement' => (string) ($member->personal_statement ?? ''),
        ];
    ...
    public function store(Request $request)
    {
        ...
        $validated['specialist_focus'] = json_decode($request->input('specialist_focus', '[]'), true) ?? [];
