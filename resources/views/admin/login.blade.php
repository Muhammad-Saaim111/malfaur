...
<title>Malfaur Admin — Login</title>
...
<div class="login-wrap">
  <div class="login-card">
    <div class="logo-area">
      <img src="{{ asset('images/hexafume/hexafume-white.png') }}" alt="Malfaur Logo" style="height: 60px; margin-bottom: 1.2rem; display: block; margin-left: auto; margin-right: auto; object-fit: contain;">
      <div class="logo-title">MALFAUR</div>
    ...
    <div class="login-footer">
      © {{ date('Y') }} Malfaur. Authorized access only.
    </div>
  </div>
</div>
<script>
