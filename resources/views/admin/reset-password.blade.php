...
<title>Malfaur Admin â€” Reset Password</title>
...
<div class="login-wrap">
  <div class="login-card">
    ...
    <form method="POST" action="{{ route('admin.password.update') }}" novalidate>
      ...
      <div class="form-group">
        ...
        <div class="input-wrap">
          <input type="email" id="email" name="email" value="{{ old('email', request('email')) }}" placeholder="admin@malfaur.com" autocomplete="email" required/>
    ...
    <div class="login-footer">
      Â© {{ date('Y') }} Malfaur. Authorized access only.
    </div>
  </div>
</div>
</body>
